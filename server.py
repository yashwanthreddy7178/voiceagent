...
if not DEEPGRAM_API_KEY or not OPENAI_API_KEY or not TWILIO_ACCOUNT_SID:
                    ...
                    async for message in deepgram_ws:
                        if isinstance(message, bytes):
                            ...
                            if msg_data.get('type') == 'UserStartedSpeaking':
                                ...
                                # We could log agent speech here if Deepgram sends it, 
                                # but currently it only sends audio. 
                                pass
